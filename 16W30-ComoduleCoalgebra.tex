...
\usepackage{pmmeta}
\pmcanonicalname{ComoduleCoalgebra}
\pmcreated{2013-03-22 13:26:39}
\pmmodified{2013-03-22 13:26:39}
\pmowner{mhale}{572}
\pmmodifier{mhale}{572}
\pmtitle{comodule coalgebra}
\pmrecord{7}{34007}
\pmprivacy{1}
\pmauthor{mhale}{572}
\pmtype{Definition}
...
A \textbf{right $H$-comodule coalgebra} is a coalgebra $A$ which is a right $H$-comodule
satisfying
\begin{equation}
(\Delta\otimes\id) t(a) = \sum a_{(1)(1)} \otimes a_{(2)(1)} \otimes a_{(1)(2)}a_{(2)(2)}, \quad
(\varepsilon\otimes\id) t(a) = \varepsilon(a) \identity_H,
\end{equation}
...
Then $H$ is itself a $H$-comodule coalgebra for the adjoint coaction
$t(h) = h_{(2)} \otimes S(h_{(1)}) h_{(3)}$.
\end{example}
%%%%%
%%%%%
\end{document}
