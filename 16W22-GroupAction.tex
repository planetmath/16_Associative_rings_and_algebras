...
\usepackage{pmmeta}
\pmcanonicalname{GroupAction}
\pmcreated{2013-03-22 12:12:17}
\pmmodified{2013-03-22 12:12:17}
\pmowner{djao}{24}
\pmmodifier{djao}{24}
\pmtitle{group action}
\pmrecord{10}{31516}
\pmprivacy{1}
\pmauthor{djao}{24}
\pmtype{Definition}
...
\pmrelated{Group}
\pmdefines{effective}
\pmdefines{effective group action}
\pmdefines{faithful}
\pmdefines{faithful group action}
\pmdefines{transitive}
\pmdefines{transitive group action}
\pmdefines{left action}
\pmdefines{right action}
\pmdefines{faithfully}
\pmdefines{action}
\pmdefines{act on}
\pmdefines{acts on}
