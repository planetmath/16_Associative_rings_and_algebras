...
\usepackage{pmmeta}
\pmcanonicalname{CompletelyReducible}
\pmcreated{2013-03-22 13:21:13}
\pmmodified{2013-03-22 13:21:13}
\pmowner{Mathprof}{13753}
\pmmodifier{Mathprof}{13753}
\pmtitle{completely reducible}
\pmrecord{7}{33873}
\pmprivacy{1}
...
\pmsynonym{semisimple}{CompletelyReducible}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A module  is called {\em completely reducible} (or {\em semisimple}) if it is a direct sum of irreducible (or simple) modules.
%%%%%
%%%%%
\end{document}
