...
\usepackage{pmmeta}
\pmcanonicalname{Supercommutative}
\pmcreated{2013-03-22 13:25:18}
\pmmodified{2013-03-22 13:25:18}
\pmowner{rmilson}{146}
\pmmodifier{rmilson}{146}
\pmtitle{supercommutative}
\pmrecord{7}{33973}
\pmprivacy{1}
...
\pmsynonym{graded-commutative}{Supercommutative}
\pmsynonym{supercommutative algebra}{Supercommutative}
\pmsynonym{even element}{Supercommutative}
\pmsynonym{odd element}{Supercommutative}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $R$ be a $\Z_2$-graded ring (or more generally, an associative algebra).  We say that $R$ is {\em supercommutative} if for any homogeneous elements $a$ and $b\in R$:
