...
\usepackage{pmmeta}
\pmcanonicalname{Coinvariant}
\pmcreated{2013-03-22 13:57:40}
\pmmodified{2013-03-22 13:57:40}
\pmowner{mhale}{572}
...
\begin{document}
Let $V$ be a comodule with a right coaction $t\colon V \to V\otimes A$ of a coalgebra $A$.
An element $v \in V$ is \textbf{right coinvariant} if
\begin{equation}
t(v) = v\otimes\identity_A.
\end{equation}
The set of coinvariants of $A$ is a sub-comodule with the trivial coaction of $A$.
The sub-comodule of right (or left) coinvariants of $V$ is sometimes denoted by $V^{\mathrm{co}A}$ (or ${}^{\mathrm{co}A}V$).
%%%%%
%%%%%
\end{document}
